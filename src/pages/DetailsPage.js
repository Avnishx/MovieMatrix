        ...
        <div className='relative mx-auto lg:-mt-28 lg:mx-0 w-fit min-w-60'>
          ...
          <button
            ...
            className='mt-3 w-full py-2 px-4 text-center bg-white text-black rounded font-bold text-lg 
             hover:bg-gradient-to-l from-red-500 to-orange-500 hover:scale-105 transition-all duration-300'
          >
            Play Now
          </button>
          ...
          <button
            ...
            className="mt-3 w-full py-2 px-4 text-center bg-fuchsia-600 text-white rounded font-bold text-lg
             hover:bg-gradient-to-r from-pink-500 via-rose-500 to-red-500
